        ...
        <form action="{{ route('basic-informations.store') }}" class="mt-6 space-y-5" method="POST"
            ...
            <div class="grid grid-cols-3 gap-8 mt-6"
                ...
                <div
                    ...
                    <label for="states" class="block text-sm text-black-700 capitalize dark:text-balck-200">الولاية</label>
                    <select name="state_id" x-model="selectedState"
                        class="block w-full px-3 py-2 mt-2 text-black-200 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40"
                        required>
                        <option></option>
            ...
            <div
                x-init="$watch('selectedlocal', (selectedlocal) => { fetch('http://localhost:8000/locals/regions/' + selectedlocal).then(res=> res.json()).then((regionData) => { regions = regionData }) })">
                <label for="project_status" class="block text-sm text-gray-700 capitalize dark:text-black-200">حاله المشروع:</label>
                <select name="project_status" x-model="selectedlocal"
                    ...
                    <option :value="0" name="project_status">
                        قيد التنفيذ
                    </option>
                    <option :value="1" name="project_status">
                        تم التنفيذ
                    </option>
            ...
            <div class="grid grid-cols-2 gap-8 mt-6">
                <div>
                    ...
                    <input type="text" name="project_name" placeholder=" إسم المشروع" value="{{ old('project_name') }}"
            ...
            <div class="grid grid-cols-2 gap-8 mt-6">
                <div>
                    <label for="region" name="total_cost"
                        class="block text-sm text-gray-700 capitalize dark:text-black-200">  التكلفة الكليه (بالدولار)</label>

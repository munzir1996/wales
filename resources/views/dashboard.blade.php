...
<section class="mt-6 space-y-6">
    <div class="w-full p-4 bg-white rounded-lg xl:p-6">
        ...
        <div>
            <h1 class="text-lg font-medium text-gray-700 capitalize sm:text-xl md:text-2xl">active users</h1>
            ...
            <div class="grid gap-12 mt-8 sm:grid-cols-2 md:grid-cols-4">
                <div>
                    <div class="flex items-center space-x-3 capitalize">
                        ...
                        <div class="font-medium text-gray-500 ">users</div>
                    </div>
                ...
                <div>
                    <div class="flex items-center space-x-3 capitalize">
                        ...
                        <div class="font-medium text-gray-500 ">Clicks</div>
                    </div>
                ...
                <div>
                    <div class="flex items-center space-x-3 capitalize">
                        ...
                        <div class="font-medium text-gray-500 ">Sales</div>
                    </div>
                ...
                <div>
                    <div class="flex items-center space-x-3 capitalize">
                        ...
                        <div class="font-medium text-gray-500 ">Items</div>
                    </div>
    ...
    <div class="w-full p-5 overflow-hidden bg-white rounded-lg">
        <div class="mb-2">
            <h1 class="text-lg font-medium text-gray-700 capitalize sm:text-xl md:text-2xl">sales overview</h1>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 font-medium whitespace-nowrap">
                                        <div class="relative z-0 flex -space-x-1 overflow-hidden">
                                            <img class="relative z-40 inline-block w-6 h-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="">
                                            <img class="relative z-30 inline-block w-6 h-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                                            <img class="relative z-20 inline-block w-6 h-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                                            <img class="relative z-10 inline-block w-6 h-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80" alt="">
                                            <img class="relative z-0 inline-block w-6 h-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                    ...
                    <div class="relative pb-8">
                        ...
                        <div class="relative flex space-x-3">
                            <div>
                                <span
                                    class="flex items-center justify-center w-8 h-8 bg-white rounded-full ring-8 ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="relative pb-8">
                        ...
                        <div class="relative flex space-x-3">
                            <div>
                                <span
                                    class="flex items-center justify-center w-8 h-8 bg-white rounded-full ring-8 ring-white">
                                       <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-cyan-500" viewBox="0 0 20 20" fill="currentColor">
